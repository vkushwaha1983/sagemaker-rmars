...
r_training_params = {
    ...
    "AlgorithmSpecification": {
        "TrainingImage": '{}.dkr.ecr.{}.amazonaws.com/sagemaker-prviledge:latest'.format(account, region),
...
r_hosting_container = {
    'Image': '{}.dkr.ecr.{}.amazonaws.com/sagemaker-prviledge:latest'.format(account, region),
...
r_endpoint = 'sagemaker-endpoint-dockerpri'
print(r_endpoint)
